...
import  {fetchNotes,DeleteNote,UpdateNote}  from "../store/slices/noteslice";
...
const ViewNotes = () => {
  ...
  try {
    axios.put(BASE_URL= "http://localhost:3001/api");
    const updatedNote = {
      ...noteData,
      title: "Updated Title",
    ...
    await dispatch(UpdateNote({ id, UpdatedData: UpdateNote }));
  } catch (err) {
